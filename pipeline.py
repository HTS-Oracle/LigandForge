...
class LigandForgePipeline:
    ...
    def run_full_pipeline(self, 
        ...
        try:
            ...
            voxel_analysis = None
            if kwargs.get('include_voxel_analysis', False):
    ...
    def _analyze_binding_site(self, pdb_text: str, center: np.ndarray, radius: float):
        ...
        print(f"Analyzing binding site (center: {center}, radius: {radius} Ã…)...")
    ...
    def _perform_voxel_analysis(self, pdb_text: str, center: np.ndarray, radius: float):
        ...
        print(f"  Cavity volume: {voxel_results.cavity_volume:.1f} Ã…Â³")
        print(f"  Surface area: {voxel_results.surface_area:.1f} Ã…Â²")
    ...
    def create_report(self) -> str:
        ...
        report.append(f"Pocket Volume: {pocket.volume:.1f} Ã…Â³")
        report.append(f"Surface Area: {pocket.surface_area:.1f} Ã…Â²")
